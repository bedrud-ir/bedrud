...
The package installs the binary to `/usr/local/bin/bedrud` and registers an init service (systemd/OpenRC/SysV auto-detected). After installing, run the interactive installer:
