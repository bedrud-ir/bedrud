...
El paquete instala el binario en `/usr/local/bin/bedrud` y registra un servicio init (systemd/OpenRC/SysV detección automática). Después de instalar, ejecuta el instalador interactivo:
