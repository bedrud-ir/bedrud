...
Пакет устанавливает бинарник в `/usr/local/bin/bedrud` и регистрирует init-сервис (systemd/OpenRC/SysV автоопределение). После установки запустите интерактивный установщик:
