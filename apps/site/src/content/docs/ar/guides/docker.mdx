...
- [مرجع الإعدادات](/ar/docs/getting-started/configuration) - جميع خيارات الإعداد ومتغيرات البيئة
- [دليل النشر](/ar/docs/guides/deployment) - النشر في الإنتاج باستخدام Docker
