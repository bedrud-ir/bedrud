...
يكتشف المُثبّت تلقائياً `windows_arm64` ويقوم بتنزيل الملف الثنائي الأصلي. إذا كنت بحاجة إلى فرض هيكلية معينة، فقم بتنزيل ملف zip المحدد من [الإصدارات](https://github.com/bedrud-ir/bedrud/releases).
