...
**وثائق ذات صلة:** [دليل التثبيت](/ar/docs/getting-started/installation) • [دليل النشر](/ar/docs/guides/deployment) • [منطق نشر الخلفية](/ar/docs/backend/deployment)
...
**وثائق ذات صلة:** [دليل التثبيت - إزالة التثبيت](/ar/docs/getting-started/installation#uninstallation)
...
- [دليل التثبيت](/ar/docs/getting-started/installation) - شرح مفصّل لـ `bedrud install`، طوبولوجيات TLS، خطوات ما بعد التثبيت
- [مرجع التهيئة](/ar/docs/getting-started/configuration) - بنية ملف تهيئة الخادم و LiveKit
- [منطق نشر الخلفية](/ar/docs/backend/deployment) - كيف يعمل `install` و `uninstall` داخلياً
- [دليل النشر](/ar/docs/guides/deployment) - خيارات النشر الكاملة بما في ذلك خدمات نظام التهيئة
