...
Paket, ikili dosyayı `/usr/local/bin/bedrud` konumuna kurar ve bir init servisi (systemd/OpenRC/SysV otomatik algılanır) kaydeder. Kurulumdan sonra etkileşimli yükleyiciyi çalıştırın:
