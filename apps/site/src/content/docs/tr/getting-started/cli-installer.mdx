...
Yükleyici `windows_arm64` mimarisini otomatik olarak algılar ve yerel ikili dosyayı indirir. Bir mimariyi zorlamanız gerekirse, [Sürümler](https://github.com/bedrud-ir/bedrud/releases) sayfasından belirli zip dosyasını indirin.
