...
1. Détecte l'OS, l'architecture CPU, les variantes de plateforme (Rosetta 2) et le système d'initialisation
...
Pris en charge sur : La plupart des distributions Linux (systemd, OpenRC, SysV init), WSL1 et les conteneurs Linux.
