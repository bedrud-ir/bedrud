...
Le paquet installe le binaire dans `/usr/local/bin/bedrud` et enregistre un service init (systemd/OpenRC/SysV détection automatique). Après l'installation, exécutez l'installateur interactif :
