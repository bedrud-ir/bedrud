...
Das Paket installiert das Binary nach `/usr/local/bin/bedrud` und registriert einen Init-Service (systemd/OpenRC/SysV automatisch erkannt). Führen Sie nach der Installation das interaktive Installationsprogramm aus:
