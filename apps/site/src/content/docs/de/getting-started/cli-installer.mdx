...
1. Erkennt Betriebssystem, CPU-Architektur, Plattformvarianten (Rosetta 2) und Init-System (systemd/OpenRC/SysV/Container)
...
lattform verfügt möglicherweise noch nicht über eine vorkompilierte Binärdatei
...
as entsprechende Zip-Archiv von [Releases](https://github.com/bedrud-ir/bedrud/releases) herunter.
