...
<div
    class="min-h-screen bg-background transition-colors duration-200"
    class:dark={darkMode}
>
    <!-- Header -->
    <header
    ...
    <main class="container py-8 space-y-12">
        ...
        <section class="text-center max-w-3xl mx-auto">
            ...
            <p class="text-xl text-muted-foreground">
                A comprehensive collection of UI components and guidelines for
        ...
        <section>
            ...
            <div class="grid sm:grid-cols-3 gap-6">
                <Card.Root>
                    <Card.Header>
                        <div
                            class="h-10 w-10 rounded-md bg-primary/10 flex items-center justify-center mb-2"
                        >
                            <Palette class="h-5 w-5 text-primary" />
                        </div>
                        <Card.Title>Minimal & Focused</Card.Title>
                        <Card.Description
                            >Clear purpose, reduced visual clutter</Card.Description
                        >
                    </Card.Header>
                </Card.Root>
                ...
                <Card.Root>
                    <Card.Header>
                        ...
                        <Card.Description
                            >Intentional typography and spacing</Card.Description
                        >
                    </Card.Header>
                </Card.Root>
                ...
                <Card.Root>
                    <Card.Header>
                        ...
                        <Card.Description
                            >Works on all device sizes</Card.Description
                        >
                    </Card.Header>
                </Card.Root>
            </div>
        ...
        <section>
            ...
            <Card.Root class="mb-6">
                <Card.Header>
                    ...
                    <Card.Description
                        >Different styles for different contexts</Card.Description
                    >
                </Card.Header>
                <Card.Content>
                ...
                <Card.Root>
                    ...
                    <Card.Content>
                        <div class="space-y-4 h-40">
                            <div
                                class="bg-muted rounded-lg h-1/3 flex items-center justify-center"
                            >
                                Header
                            </div>
                            <div
                                class="bg-muted rounded-lg h-2/3 flex items-center justify-center"
                            >
                                Content
                            </div>
                        </div>
        ...
        <section>
            ...
            <Card.Root>
                ...
                <Card.Content>
                    <div class="relative">
                        <pre
                            class="bg-muted p-4 rounded-lg overflow-x-auto"><code
                                >npm install @bedrud/ui
# or
pnpm add @bedrud/ui</code
                            ></pre>
                        <Button
                            variant="ghost"
                            size="icon"
        ...
        <section>
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <Card.Root>
                    ...
                    <Card.Content>
                        <ul
                            class="list-disc pl-5 space-y-2 text-muted-foreground"
                        >
